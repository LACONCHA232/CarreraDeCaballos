...
import java.util.Observer; // para poder notificar entre objetos sobre cambios que se hacen en el proceso, como los porcentajes

public class FrmCarrera extends javax.swing.JFrame implements Observer {

    private Thread[] hilos;
    
    /// Hilo para poder hacer flujo de control mas optimo, ademas para hacer tareas al mismo tiempo
    public FrmCarrera() {
        initComponents();
        hilos = new Thread[4];
    }
    ...
    /// Para poder iniciar cada caballo al mismo tiempo y actualizarlo cuando le toque (BOTON)
    ...
    /// Para interrupir cada hilo al terminar uno y poder ver su porcentaje final
    ...
    /// aqui es para que se actualice constantemente los procentajes de los 4 caballos, mediante hilos de la clase caballo
    @Override
    public void update(Observable o, Object arg) { 
        ...
        if(porcentaje>=100){
           terminar();
           this.btnIniciar.setEnabled(true); // que el boton de Iniciar se pueda volver a usar
           this.lblGanador.setText("Caballo "+c.getNombre()); // mostrar Ganador
        }
